...
const BEAD_ID: &str = "bd-1xds";
const ISSUES_JSONL: &str = ".beads/issues.jsonl";
const UNIT_TEST_IDS: [&str; 2] = [
    "test_bd_1xds_unit_compliance_gate",
    "prop_bd_1xds_structure_compliance",
];
const E2E_TEST_IDS: [&str; 2] = ["test_e2e_bd_1xds", "test_e2e_bd_1xds_compliance"];
...
#[test]
fn test_bd_1xds_unit_compliance_gate() -> Result<(), String> {
...
proptest! {
    #[test]
    fn prop_bd_1xds_structure_compliance(missing_index in 0usize..REQUIRED_TOKENS.len()) {
...
#[test]
fn test_e2e_bd_1xds_compliance() -> Result<(), String> {
    let description = load_issue_description(BEAD_ID)?;
    let evaluation = evaluate_description(&description);
...
#[test]
fn test_e2e_bd_1xds() -> Result<(), String> {
    test_e2e_bd_1xds_compliance()
}
