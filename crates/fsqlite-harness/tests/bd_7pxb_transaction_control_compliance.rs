...
const BEAD_ID: &str = "bd-7pxb";
const ISSUES_JSONL: &str = ".beads/issues.jsonl";
const UNIT_TEST_IDS: [&str; 2] = [
    "test_bd_7pxb_unit_compliance_gate",
    "prop_bd_7pxb_structure_compliance",
];
const E2E_TEST_IDS: [&str; 1] = ["test_e2e_bd_7pxb_compliance"];
const LOG_LEVEL_MARKERS: [&str; 4] = ["DEBUG", "INFO", "WARN", "ERROR"];
const LOG_STANDARD_REF: &str = "bd-1fpm";
const REQUIRED_TOKENS: [&str; 8] = [
    "test_bd_7pxb_unit_compliance_gate",
    "prop_bd_7pxb_structure_compliance",
    "test_e2e_bd_7pxb_compliance",
    "DEBUG",
    "INFO",
    "WARN",
    "ERROR",
...
#[test]
fn test_bd_7pxb_unit_compliance_gate() -> Result<(), String> {
...
proptest! {
    #[test]
    fn prop_bd_7pxb_structure_compliance(missing_index in 0usize..REQUIRED_TOKENS.len()) {
...
#[test]
fn test_e2e_bd_7pxb_compliance() -> Result<(), String> {
    let description = load_issue_description(BEAD_ID)?;
    let evaluation = evaluate_description(&description);
