...
const BEAD_ID: &str = "bd-1uzb";
const ISSUES_JSONL: &str = ".beads/issues.jsonl";
const UNIT_TEST_IDS: [&str; 2] = [
    "test_bd_1uzb_unit_compliance_gate",
    "prop_bd_1uzb_structure_compliance",
];
const NORMALIZED_HELPER_TEST_IDS: [&str; 4] = [
    "test_fixture_roundtrip_builder_deterministic",
    "test_oracle_runner_captures_extended_codes",
    "test_result_diff_is_stable",
    "test_artifact_bundle_layout",
];
const E2E_TEST_IDS: [&str; 1] = ["test_e2e_bd_1uzb_compliance"];
const LOG_LEVEL_MARKERS: [&str; 4] = ["DEBUG", "INFO", "WARN", "ERROR"];
const LOG_STANDARD_REF: &str = "bd-1fpm";
const REQUIRED_TOKENS: [&str; 12] = [
    "test_bd_1uzb_unit_compliance_gate",
    "prop_bd_1uzb_structure_compliance",
    "test_e2e_bd_1uzb_compliance",
    "test_fixture_roundtrip_builder_deterministic",
    "test_oracle_runner_captures_extended_codes",
    "test_result_diff_is_stable",
    "test_artifact_bundle_layout",
...
struct ComplianceEvaluation {
    ...
    missing_normalized_helper_ids: Vec<&'static str>,
...
impl ComplianceEvaluation {
    fn is_compliant(&self) -> bool {
        self.missing_unit_ids.is_empty()
            && self.missing_normalized_helper_ids.is_empty()
...
fn evaluate_description(description: &str) -> ComplianceEvaluation {
    ...
    let missing_normalized_helper_ids = NORMALIZED_HELPER_TEST_IDS
        .into_iter()
        .filter(|id| !description.contains(id))
        .collect::<Vec<_>>();
...
#[test]
fn test_bd_1uzb_unit_compliance_gate() -> Result<(), String> {
    ...
    if !evaluation.missing_normalized_helper_ids.is_empty() {
        return Err(format!(
            "bead_id={BEAD_ID} case=normalized_helper_ids_missing missing={:?}",
            evaluation.missing_normalized_helper_ids
        ));
    }
...
proptest! {
    #[test]
    fn prop_bd_1uzb_structure_compliance(missing_index in 0usize..REQUIRED_TOKENS.len()) {
        let mut synthetic = format!(
            "## Unit Test Requirements\n- {}\n- {}\n- {}\n- {}\n- {}\n- {}\n\n## E2E Test\n- {}\n\n## Logging Requirements\n- DEBUG: stage progress\n- INFO: summary\n- WARN: degraded mode\n- ERROR: terminal failure\n- Reference: {}\n",
            UNIT_TEST_IDS[0],
            UNIT_TEST_IDS[1],
            NORMALIZED_HELPER_TEST_IDS[0],
            NORMALIZED_HELPER_TEST_IDS[1],
            NORMALIZED_HELPER_TEST_IDS[2],
            NORMALIZED_HELPER_TEST_IDS[3],
            E2E_TEST_IDS[0],
            LOG_STANDARD_REF,
        );
...
#[test]
fn test_e2e_bd_1uzb_compliance() -> Result<(), String> {
    let description = load_issue_description(BEAD_ID)?;
    let evaluation = evaluate_description(&description);
    ...
    eprintln!(
        "INFO bead_id={BEAD_ID} case=e2e_summary missing_unit_ids={} missing_normalized_helper_ids={} missing_e2e_ids={} missing_log_levels={} missing_log_standard_ref={}",
        evaluation.missing_unit_ids.len(),
        evaluation.missing_normalized_helper_ids.len(),
    ...
    for id in &evaluation.missing_normalized_helper_ids {
        eprintln!("WARN bead_id={BEAD_ID} case=missing_normalized_helper_id id={id}");
    }
